...
;
;
const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'data', 'signals.json');
function getSignals() {
    try {
        ...
        const fileData = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(filePath, 'utf8').trim();
        if (!fileData) return [];
...
function saveSignals(signals) {
    ...
    __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(filePath, JSON.stringify(signals, null, 2));
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0pyu7sb._.js.map